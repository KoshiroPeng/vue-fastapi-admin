...
CREATE TABLE IF NOT EXISTS `wifi_external_call_log` (
    `id` BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `created_at` DATETIME(6) NOT NULL  DEFAULT CURRENT_TIMESTAMP(6),
    `updated_at` DATETIME(6) NOT NULL  DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    `trace_id` VARCHAR(64) NOT NULL,
    `auth_tx_id_hash` VARCHAR(64),
    ...
    `error_message_masked` VARCHAR(512),
    KEY `idx_wifi_extern_created_e11248` (`created_at`),
    KEY `idx_wifi_extern_updated_f2e744` (`updated_at`),
    KEY `idx_wifi_extern_trace_i_7dbbf1` (`trace_id`),
    KEY `idx_wifi_extern_auth_tx_4241ae` (`auth_tx_id_hash`),
    KEY `idx_wifi_extern_system__a55902` (`system_name`),
    KEY `idx_wifi_extern_api_nam_a1c33f` (`api_name`),
    KEY `idx_wifi_extern_result__b8f8c0` (`result_code`),
    KEY `idx_wifi_extern_success_0060d9` (`success`)
) CHARACTER SET utf8mb4;
