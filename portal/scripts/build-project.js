...
function renderDirectory(directory, locale, projectName, language) {
...
function buildProject(projectName, options = {}) {
  ...
  copyDirectory(sourceDir, zhDir)
  copyDirectory(sourceDir, translatedDir)
  renderDirectory(zhDir, locales.zh, projectName, 'zh')
  renderDirectory(translatedDir, locales.trl, projectName, 'trl')
